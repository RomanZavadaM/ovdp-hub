...
class HubStrings {
  ...
  static const Map<String, Map<String, String>> _translations = {
    'uk': {
      ...
      'notConfirmed': 'Наявність і кількість не підтверджені', 'none': 'немає', 'otherSellers': 'Інші продавці',
    ...
    'en': {
      ...
      'notConfirmed': 'Availability and quantity are not confirmed', 'none': 'none',
