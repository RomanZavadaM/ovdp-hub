...
## Що увійшло в опублікований v0.8.7 поверх v0.8.6
...
Release pipeline **Publish native prerelease run #37** успішно завершив:
- `flutter pub get --enforce-lockfile`;
- `flutter analyze`;
- `flutter test`;
- Windows release build + packaging;
...
Release notes опубліковано сімома мовами інтерфейсу: **Українська / English / Français / Deutsch / Español / 한국어 / 日本語**.

Tag/release не пересуваємо й не переписуємо.

## Чому 0.8.7, а не 0.9.0

У v0.8.7 уже входять explicit price-source priority та purchase-fee assumptions, але **ще не завершені**:
