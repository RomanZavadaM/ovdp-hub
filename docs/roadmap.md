...
5. **Порівняння рішень — DONE**: neutral A/B/C comparison для 2–3 збережених сценаріїв зі strict comparability та explanatory metrics — PR #58, final run #183.
...
**v0.8.8 / 0.8.8+16** опубліковано 23.09.2026 з verified-tax, explicit-FX, per-position exit та typed recurring-needs verticals. Повний release pipeline run #40 успішний для Windows/macOS/Android/iOS/START. Після checkpoint у `main` інтегровано strict A/B/C comparison; наступний крок — generated planner copy / preset labels localization + UX regression.
...
- [x] Порівняння альтернативних сценаріїв A/B/C — PR #58, final run #183.
