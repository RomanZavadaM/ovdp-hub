...
void main() {
  ...
  test('portfolio sale history and migration controls are localized', () {
    const keys = [
      ...
      'portfolioCashSummaryInfo',
      'portfolioCashPurchases',
      'portfolioCashSales',
      'portfolioCashCoupons',
      'portfolioCashRedemptions',
      'portfolioCashKnownFees',
      'portfolioCashUnknownFeesFlag',
      'portfolioCashNet',
      'portfolioCashNetUnknown',
  ...
  test('portfolio and economic pulse are localized in every supported language', () {
    const keys = [
      ...
      'portfolioRecoveryConfirm',
      'portfolioRecoveryMismatch',
      'portfolioRecoveryBackupTitle',
      'portfolioRecoveryBackupInfo',
      'portfolioBackupCreate',
      'portfolioBackupSaved',
      'portfolioBackupUnavailable',
      'portfolioRecoveryChange',
      'portfolioRecoveryChangeTitle',
      'portfolioRecoveryChanged',
      'portfolioRestoreBackup',
      'portfolioRestoreTitle',
      'portfolioRestoreExplain',
      'portfolioRestoreDone',
